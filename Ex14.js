...
console.log(' ')
//ex14.2
/* Siobhan is in the process of creating a brand new word game that she hopes 
...
Hint:You will need to check if the last letter is equal 
to s. If a string has n characters, then it’s last letter is at what index?*/
