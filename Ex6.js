...
console.log(" ")
console.log("Ex6.2")
console.log("Lovely Weather" == 'Lovely Weather'); // ==, true
console.log("Weather" < "Lovely"); // <, false
console.log("lovely" !== "lovely"); // !==, false
console.log("Lovely Weather, he said."!= "'Lovely Weather,' he said."); // !=, true
