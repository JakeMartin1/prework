...
console.log(`The fourth pet in the array is currently ${pets[3]}.`); 
//remember that the fourth item is at index 3
...
console.log(partialGrades); 
//observe what happens when we log an entire array